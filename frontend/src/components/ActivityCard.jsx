...
const ActivityCard = ({ deletedData, openModalDelete, data }) => {
  ...
  return (
    <>
      ...
      >
        <div
          data-cy="activity-item-body"
          className="h-[90%] overflow-y-auto"
          onClick={(e) => toDetailActivity(e)}
        >
          <h4 data-cy="activity-item-title" className="text-[18] break-words">
            {data.title}
          </h4>
        </div>
        <div data-cy="activity-item-footer" className="flex justify-between">
          <span
