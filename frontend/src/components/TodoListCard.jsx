...
import { updateTodo } from "../store/actionCreator/todoAction";
import { useEffect } from "react";

const TodoListCard = ({ data, edit, activityId, successDelete }) => {
  ...
  useEffect(() => {
    setIsChecked(data.is_active === 0 ? true : false);
  }, []);
  ...
  const handleChecklist = (e) => {
    ...
    dispatch(updateTodo(data.id, payload));
  };
  ...
  return (
    <>
      <div
        ...
        className="w-full bg-text-white shadow-lg border border-second-white flex items-center justify-between p-5"
      >
        <div
          data-cy="todo-list-item-content"
