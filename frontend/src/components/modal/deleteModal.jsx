...
const DeleteModal = ({
  ...
  return (
    <>
      <div
        data-cy={penanda === "Activity" ? "" : "todo-item-delete-button"}
      ...
      >
        <div
          data-cy="delete-modal-content"
          className="relative w-auto my-6 mx-auto max-w-lg align-middle sm:flex sm:justify-center"
        >
          {/*content*/}
          <div
            data-cy=""
          ...
          >
            {/*body*/}
            <div data-cy="" className="relative p-6 flex-auto text-center">
              ...
              <p
                data-cy="delete-modal-title"
                className="my-4 sm:text-md md:text-lg leading-relaxed"
              >
            ...
            >
              <button
                ...
                className="bg-second-white font-bold sm:px-8 md:px-12 sm:py-2 md:py-3.5 text-secondary-text text-md rounded-full"
                onClick={closeModal}
              >
                Batal
              </button>
              <button
                ...
                className="bg-red font-bold sm:px-8 md:px-12 sm:py-2 md:py-3.5 text-text-white text-md rounded-full"
